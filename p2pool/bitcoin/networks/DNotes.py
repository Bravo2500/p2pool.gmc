...
BLOCK_EXPLORER_URL_PREFIX = 'http://explorer.cryptoblox.com/block/'
ADDRESS_EXPLORER_URL_PREFIX = 'http://explorer.cryptoblox.com/address/'
TX_EXPLORER_URL_PREFIX = 'http://explorer.cryptoblox.com/tx/'
